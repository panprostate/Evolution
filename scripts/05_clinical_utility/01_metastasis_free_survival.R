...
write_tsv(
  ...
  file.path(outdir, "SF24a_source_data.tsv")
)
pdf(file.path(figdir, "SF24a_mfs_by_subclonal_dynamics_spop_wt.pdf"), height = 100/25.3, width = 120/25.3)
...
write_tsv(
  ...
  file.path(outdir, "SF24c_source_data.tsv")
)
pdf(file.path(figdir, "SF24c_mfs_by_subclonal_dynamics_clinical_and_genetic.pdf"), height = 100/25.3, width = 120/25.3)
ggforest(model, data = met_relapse)
dev.off()
...
write_tsv(
  ...
  file.path(outdir, "SF24b_source_data.tsv")
)
pdf(file.path(figdir, "SF24b_mfs_by_subclonal_dynamics_tsg_alt.pdf"), height = 100/25.3, width = 120/25.3)
ggforest(model, data = met_relapse)
dev.off()
...
write_tsv(
  ...
  file.path(outdir, "SF24d_source_data.tsv")
)
pdf(file.path(figdir, "SF24d_km_evorisk_damico.pdf"),  height = 80/25.3, width = 80/25.3)
...
write_tsv(
  ...
  file.path(outdir, "SF24e_source_data.tsv")
)
pdf(file.path(figdir, "SF24e_km_evorisk_cpg.pdf"),  height = 80/25.3, width = 80/25.3)
ggsurvplot(km_fit, data = met_relapse,
