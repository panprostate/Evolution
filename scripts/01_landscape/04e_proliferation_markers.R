...
saveRDS(
  ...
  file.path(outdir, "SF8_source_data.rds")
)
ggsave(file.path(figdir, "SF8_proliferation_markers_by_grade_group.png"), p, width = 180/25.3, height = 120/25.3, dpi = 300)
ggsave(file.path(figdir, "SF8_proliferation_markers_by_grade_group.pdf"), p, width = 180/25.3, height = 120/25.3)
