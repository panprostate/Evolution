...
write_tsv(pt_rate_mrca_estimates, file.path(outdir, "SF5_source_data.tsv"))
ggsave(file.path(figdir, "SF5_mrca_latency_cohort_diagram.pdf"), p, width = 180/25.3, height = 180/25.3)
...
write_tsv(global_rate_mrca_estimates, file.path(outdir, "SF6_source_data.tsv"))
save_ggplot(p, file.path(figdir, "SF6_global_vs_patient_rate"), w = 180, h = 250)
