...
write_tsv(
  ...
  file.path(outdir, "SF3b_source_data.tsv")
)
ggsave(file.path(figdir, "SF3b_sig_change_clonal_subclonal_by_grade_group.png"), width = 125/25.3, height = 75/25.3, dpi = 300)
ggsave(file.path(figdir, "SF3b_sig_change_clonal_subclonal_by_grade_group.pdf"), width = 125/25.3, height = 75/25.3, dpi = 300)
