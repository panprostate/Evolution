...
write_tsv(
  ...
  file.path(OUTPUT_DIR, "SF15a_source_data.tsv")
)
ggsave(
    file.path(FIGURE_DIR, "SF15a_evotype_overlap_tcga_subtypes_donut.pdf"),
    donut_plot,
    width = 225/45.3,
    height = 100/25.3
)
...
write_tsv(
  ...
  file.path(OUTPUT_DIR, "SF15b_source_data.tsv")
)
ggsave(
    file.path(FIGURE_DIR, "SF15b_evotype_overlap_you_subtypes.pdf"),
...
write_tsv(df_sankey, file.path(OUTPUT_DIR, "SF9b_source_data.tsv"))
ggsave(file.path(FIGURE_DIR, "SF9b_sankey_woodcock_ppcg.pdf"), p, height = 50/25.4, width = 50/25.4, dpi = 300)
...
write_tsv(country_counts, file.path(OUTPUT_DIR, "SF9c_source_data.tsv"))
ggsave(file.path(FIGURE_DIR, "SF9c_trajectory_counts_by_country.pdf"), p, width = 70/25.3, height = 50/25.3, dpi = 300)
