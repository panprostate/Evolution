...
write_tsv(dmcs_wide, file.path(outdir, "SF13a_source_data.tsv"))
pdf(file.path(figdir, "SF13a_upset_plot.pdf"), width = 100/25.3, height = 125/25.3)
print(upset_plot)
dev.off()
...
write_tsv(
  ...
  file.path(outdir, "SF13b_source_data.tsv")
)
ggsave(file.path(figdir, "SF13b_methylation_differences_cmp1_cmp2.pdf"), p, width = 60/25.3, height = 60/25.3)
...
# Render the plot
write_tsv(donut_data, file.path(outdir, "SF13c_source_data.tsv"))
ggsave(donut_plot, filename = file.path(figdir, "SF13c_cpg_annotations.pdf"), width = 70/25.4, height = 70/25.4)
...
write_tsv(reg_elements, file.path(outdir, "SF13d_source_data.tsv"))
ggsave(p, filename = file.path(figdir, "SF13d_dmc_regulatory_elements.pdf"), width = 150/25.3, height = 100/25.3)
