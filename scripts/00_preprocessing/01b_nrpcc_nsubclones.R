...
# SF1a-b
write_tsv(df %>% dplyr::select(nrpcc, nsubclones, min_ccf), file.path(outdir, "SF1ab_source_data.tsv"))
save_ggplot(p, file.path(figdir, "SF1ab_nrpcc_power_subclonality"), w = 110, h = 65)
