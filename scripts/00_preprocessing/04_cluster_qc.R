...
dpclust_vs_phylogic_comparison = foreach(sample_id = qc_pass_samples) %dopar% {
    ...
    if (sample_id == "PPCG1060a_DNA") {
        write_tsv(
          ...
          file.path(OUTPUT_DIR, "SF2d_source_data.tsv")
        )
    }
    ggsave(
    ...
    if (sample_id == "PPCG0004a_DNA") {
        write_tsv(
          ...
          file.path(OUTPUT_DIR, "SF2a_source_data.tsv")
        )
    }
    ggsave(
...
write_tsv(dpclust_vs_phylogic_comparison %>% dplyr::select(ari), file.path(OUTPUT_DIR, "SF2e_source_data.tsv"))
ggsave(file.path(FIGURE_DIR, "SF2e_dpclust_vs_phylogic_ari_histogram.png"), clustering_ari_histogram, width = 65/25.3, height = 65/25.3)
ggsave(file.path(FIGURE_DIR, "SF2e_dpclust_vs_phylogic_ari_histogram.pdf"), clustering_ari_histogram, width = 65/25.3, height = 65/25.3)
...
write_tsv(dpclust_vs_phylogic_comparison %>% dplyr::select(pearson), file.path(OUTPUT_DIR, "SF2b_source_data.tsv"))
ggsave(file.path(FIGURE_DIR, "SF2b_dpclust_vs_phylogic_ccf_pearson_histogram.png"), ccf_correlation_histogram, width = 65/25.3, height = 65/25.3)
ggsave(file.path(FIGURE_DIR, "SF2b_dpclust_vs_phylogic_ccf_pearson_histogram.pdf"), ccf_correlation_histogram, width = 65/25.3, height = 65/25.3)
...
write_tsv(
  ...
  file.path(OUTPUT_DIR, "SF2c_source_data.tsv")
)
ggsave(file.path(FIGURE_DIR, "SF2c_scatterplot_dpclust_vs_phylogic_nsubclones.png"), subclones_comparison_heatmap, width = 65/25.3, height = 65/25.3)
ggsave(file.path(FIGURE_DIR, "SF2c_scatterplot_dpclust_vs_phylogic_nsubclones.pdf"), subclones_comparison_heatmap, width = 65/25.3, height = 65/25.3)
...
write_tsv(dpclust_vs_phylogic_with_evolution %>% dplyr::select(ari, subclonal_pga_group), file.path(OUTPUT_DIR, "SF2f_source_data.tsv"))
ggsave(file.path(FIGURE_DIR, "SF2f_dpclust_vs_phylogic_ari_histogram_by_subclonal_pga_group.png"), ari_histogram, height = 65/25.3, width = 65/25.3)
ggsave(file.path(FIGURE_DIR, "SF2f_dpclust_vs_phylogic_ari_histogram_by_subclonal_pga_group.pdf"), ari_histogram, height = 65/25.3, width = 65/25.3)
...
write_tsv(
  ...
  file.path(OUTPUT_DIR, "SF2g_source_data.tsv")
)
ggsave(file.path(FIGURE_DIR, "SF2g_dpclust_vs_phylogic_ccf_scatter_clonal_cn.png"), ccf_scatter_clonal, height = 65/25.3, width = 65/25.3)
write_tsv(
  dpclust_data %>% dplyr::filter(copy_number_status == "Subclonal CN") %>%
    dplyr::select(truncated_ccf, phylogic_ccf, copy_number_status),
  file.path(OUTPUT_DIR, "SF2h_source_data.tsv")
)
ggsave(file.path(FIGURE_DIR, "SF2h_dpclust_vs_phylogic_ccf_scatter_subclonal_cn.png"), ccf_scatter_subclonal, height = 65/25.3, width = 65/25.3)
