...
write_tsv(
  ...
  file.path(outdir, "SF22_source_data.tsv")
)
ggsave(file.path(figdir, "SF22_simulated_progression_gg_alternative_models.pdf"), width = 160/25.3, height = 100/25.3, dpi = 300)
...
write_tsv(
  ...
  file.path(outdir, "SF23_source_data.tsv")
)
pdf(file.path(figdir, "SF23_rate_forest_plots.pdf"), width = 120/25.3, height = 180/25.3)
