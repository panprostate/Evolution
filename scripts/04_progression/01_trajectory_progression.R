...
write_tsv(pair_tj %>% dplyr::select(s1_tj, s2_tj), file.path(outdir, "SF20_source_data.tsv"))
ggsave(file.path(figdir, "SF20_tj_transitions_sankey.pdf"), plot = p, width = 150/25.3, height = 100/25.3)
