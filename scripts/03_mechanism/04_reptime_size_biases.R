...
write_tsv(
  ...
  file.path(outdir, "SF19c_source_data.tsv")
)
ggsave(file.path(figdir, "SF19c_LOH_clonal_size_vs_reptime.pdf"), p, width = 80/25.4, height = 60/25.3)
...
write_tsv(
  ...
  file.path(outdir, "SF19f_source_data.tsv")
)
ggsave(file.path(figdir, "SF19f_LOH_subclonal_size_vs_reptime.pdf"), p, width = 80/25.4, height = 60/25.3)
...
write_tsv(
  ...
  file.path(outdir, "SF19d_source_data.tsv")
)
ggsave(file.path(figdir, "SF19d_HD_clonal_size_vs_reptime.pdf"), p, width = 80/25.4, height = 60/25.3)
...
write_tsv(
  ...
  file.path(outdir, "SF19g_source_data.tsv")
)
ggsave(file.path(figdir, "SF19g_HD_subclonal_size_vs_reptime.pdf"), p, width = 80/25.4, height = 60/25.3)
...
write_tsv(
  ...
  file.path(outdir, "SF19e_source_data.tsv")
)
ggsave(file.path(figdir, "SF19e_GAIN_clonal_size_vs_reptime.pdf"), p, width = 80/25.4, height = 60/25.3)
...
write_tsv(
  ...
  file.path(outdir, "SF19h_source_data.tsv")
)
ggsave(file.path(figdir, "SF19h_GAIN_subclonal_size_vs_reptime.pdf"), p, width = 80/25.4, height = 60/25.3)
